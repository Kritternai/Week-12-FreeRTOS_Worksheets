...
void app_main(void)
{
    ...
    ESP_LOGI(TAG, "LED1 (GPIO%d): Sensor task", LED1_PIN);
    ESP_LOGI(TAG, "LED2 (GPIO%d): Actuator task", LED2_PIN);
    ESP_LOGI(TAG, "Button (GPIO%d): Emergency task (Priority 5)", BUTTON_PIN);
