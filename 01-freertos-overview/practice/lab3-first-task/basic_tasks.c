...
void app_main(void)
{
    ...
    if (result4 == pdPASS) {
        ESP_LOGI(TAG, "Task Manager created successfully");
    } else {
        ESP_LOGE(TAG, "Failed to create Task Manager");
    }
